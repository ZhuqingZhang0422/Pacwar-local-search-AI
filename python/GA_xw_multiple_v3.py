...
def main():
    ...
    #res=solution.run()
    res = solution.run(generation_limit=3000000,limitsize=180,winrate=0.9, selecnumber=30,subling_limit=6,mutation_record_times=12,mutated_sites_number=6, mutation_possiblility_for_single=0.1, multiple=multiprocessing.cpu_count())
    print(res)
